...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="assets/design/css/nucleo-icons.css" rel="stylesheet" />
  <link href="assets/design/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  ...
  <link id="pagestyle" href="assets/design/css/soft-ui-dashboard.css?v=1.0.2" rel="stylesheet" />
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="adminDashboard">
        <img src="assets/img/logo.png" class="navbar-brand-img h-900" alt="...">
        <span class="ms-1 font-weight-bold">Xoom Admin</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="listofbooking">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">List Of Bookers</span>
          </a>
        </li>
        <li class="nav-item">
            <a class="nav-link  " href="listofworkercommision">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <span class="nav-link-text ms-1">List Worker Commision</span>
              </a>
          </li>
          <li class="nav-item">
          <a class="nav-link " href="listofproductcommision">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">ProductCommision</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link " href="listofworkers">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<!--           <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Username:Admin</a></li>
          </ol>
          <h6 class="font-weight-bolder mb-0" id="date" >Date:</h6> -->
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center"></div> 
            ...
            <nav aria-label="breadcrumb" class="navbar-nav  justify-content-end">

           <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <a href="sign_out" class="fa fa-sign-out"  data-toggle="tooltip" data-placement="left" title="Sign out"></a>
          </ol> 
