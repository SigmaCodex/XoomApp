                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder mb-0">
                      <?php if(isset($total_customer)){echo $total_customer;}?>
                      <span class="text-success text-sm font-weight-bolder">+<?php if(isset($today_customer)){echo $today_customer;}?></span>
                    </h5>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class=" font-weight-bolder mb-0">
                        <?php if(isset($today_customer)){echo $today_customer;}?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Completed Transaction</p>
                    <h5 class=" font-weight-bolder mb-0">
                    <?php if(isset($number_completed)){echo $number_completed;}?>
...
<!-- end of main content -->
  ...
  <script src="assets/design/js/core/bootstrap.min.js"></script>
  <script src="assets/design/js/plugins/smooth-scrollbar.min.js"></script>
  <script src="assets/design/js/plugins/chartjs.min.js"></script>
  <script src="assets/design/js/plugins/Chart.extension.js"></script>
  <script>
