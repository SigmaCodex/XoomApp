...
<body>
    ...
    <form action="sign-in" method="POST">
      <div class="form-group">
        ...
        <input style="border-radius: 10px;border-color: none; border-style: none;font-size: 14px" class="form-control" type="text" id="username" name="user_name" placeholder="JohnDoe"  required>
        </div>
      ...
      <div class="form-group">
        ...
        <input style="border-radius: 10px;border-color: none; border-style: none;font-size: 14px" class="form-control" type="password" id="password" name="pass_word" placeholder="********" required>
        </div>
